...
<body>
    ...
    <table class="chart">
        ...
        <tr>
            ...
            <td><div class="chart-container"><canvas id="FPE"></canvas></div><td>
        </tr>
        <tr>
...
<td><div class="chart-container"><canvas id="VCSH"></canvas></div><td>
            <td><div class="chart-container"><canvas id="VMC"></canvas></div><td></tr>
    </table>
    ...
    <script>
        ...
        const array = ["AMX", "ASML", "ANGL", "AVGO", "BRKB", "BEN", "BG",
            ...
            "NICE", "NVS", "NXST", "OTIS", "PANW", "PBR", "PDBC", "PLD", "PNM", "REM", "SCI", "SGOL", "SIVR", "SJNK", "SSNC", "TAIT",
